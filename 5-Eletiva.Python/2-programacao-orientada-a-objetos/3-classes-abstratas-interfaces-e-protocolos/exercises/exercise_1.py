...
class Developer(Employee):
    def calculate_bonus(self) -> str:
        return (
            f"O salário do programador {self.name} mais a"
...
class Analyst(Employee):
    def calculate_bonus(self) -> str:
        return (
            f"O salário do analista {self.name} mais a"
...
class Manager(Employee):
    def calculate_bonus(self) -> str:
        return (
            f"O salário do gerente {self.name} mais a"
...
class Worker(Employee):
    def calculate_bonus(self) -> str:
        return (
            f"O salário do colaborador {self.name} mais a"
