...
describe('Testando a API Cacau Trybe', function () {
  ...
  describe('Usando o método GET em /chocolates/brand/:brandId para buscar a brand 1', function() {
    it('Retorna os chocolates da marca Lindt & Sprrungli', async function() {
